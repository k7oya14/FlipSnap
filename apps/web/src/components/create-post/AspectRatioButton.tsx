...
const AspectRatioButton = memo(function AspectRatioButton(props: Props) {
  ...
  return (
    <div className="w-full">
      <h1 className="mb-3">Image Size</h1>
      <div className="flex items-center justify-center space-x-8">
        <button
          onClick={() => handleAspectChange(3 / 4)}
          className="border shadow-md flex flex-col rounded items-center p-1 size-16 transition duration-400 transform hover:shadow hover:translate-y-[0.5px]"
        >
